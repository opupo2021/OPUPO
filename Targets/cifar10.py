...
if __name__ == '__main__':
    ...
    _, train_loader, _, val_loader, _, test_loader = cifar10_train_val_test_split(train_batch=128, val_batch=128,
                                                                                  test_batch=128)
    cifar10_train(train_loader, test_loader, use_cuda)
    evaluate(test_loader, nn.CrossEntropyLoss(), 'cifar10_resnet18', 10, use_cuda)
