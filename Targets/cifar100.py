...
from Utils.data_split import cifar100_train_val_test_split
from Utils.misc import initialization
from Utils.model_operation import save_nn, train_epoch, test, create_nn, evaluate


def cifar100_train(train_loader, test_loader, use_cuda=True):
...
if __name__ == '__main__':
    ...
    _, train_loader, _, val_loader, _, test_loader = cifar100_train_val_test_split(train_batch=128, val_batch=128,
                                                                                   test_batch=128)
    cifar100_train(train_loader, test_loader, use_cuda)
    evaluate(test_loader, nn.CrossEntropyLoss(), 'cifar100_resnet18', 100, use_cuda)
